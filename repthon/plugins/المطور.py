...
BaqirDV_cmd = (
    "[JERUSALEM - اوامــر المطـور المســاعد](t.me/E9N99) .\n\n"
...
async def _(event):
    ...
    result = "**•❐• قائمــة مـطـورين البــوت الخـاص بـك مـن JERUSALEM :**\n\n"
    ...
    if input_str[0] == "آمن":
        ...
        for plugin in input_str:
            if plugin not in PLG_INFO:
                errors += (
                    f"`{plugin}` __There is no such plugin in your E9N99__.\n"
                )
            else:
