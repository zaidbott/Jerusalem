...
async def cpu(event):
    ...
    await edit_or_reply(
        event, f"**[E9N99](tg://need_update_for_some_feature/) CPU Model:**\n{o}"
    )
...
async def _(event):
    ...
    bbb1 = await event.edit(f"JERUSALEM **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت ريبـــثون . . .🌐**")
    await asyncio.sleep(1)
    bbb2 = await bbb1.edit("JERUSALEM **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت ريبـــثون . . .🌐**\n\n%𝟷𝟶 ▬▭▭▭▭▭▭▭▭▭")
    await asyncio.sleep(1)
    bbb3 = await bbb2.edit("JERUSALEM **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت ريبـــثون . . .🌐**\n\n%𝟸𝟶 ▬▬▭▭▭▭▭▭▭▭")
    await asyncio.sleep(1)
    bbb4 = await bbb3.edit("JERUSALEM **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت ريبـــثون . . .🌐**\n\n%𝟹𝟶 ▬▬▬▭▭▭▭▭▭▭")
    await asyncio.sleep(1)
    bbb5 = await bbb4.edit("JERUSALEM **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت ريبـــثون . . .🌐**\n\n%𝟺𝟶 ▬▬▬▬▭▭▭▭▭▭")
    await asyncio.sleep(1)
    bbb6 = await bbb5.edit("JERUSALEM **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت ريبـــثون . . .🌐**\n\n%𝟻𝟶 ▬▬▬▬▬▭▭▭▭▭")
    await asyncio.sleep(1)
    bbb7 = await bbb6.edit("JERUSALEM **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت ريبـــثون . . .🌐**\n\n%𝟼𝟶 ▬▬▬▬▬▬▭▭▭▭")
    await asyncio.sleep(1)
    bbb8 = await bbb7.edit("JERUSALEM **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت ريبـــثون . . .🌐**\n\n%𝟽𝟶 ▬▬▬▬▬▬▬▭▭▭")
    await asyncio.sleep(1)
    bbb9 = await bbb8.edit("JERUSALEM **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت ريبـــثون . . .🌐**\n\n%𝟾𝟶 ▬▬▬▬▬▬▬▬▭▭") 
    await asyncio.sleep(1)
    bbbb10 = await bbb9.edit("JERUSALEM **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت ريبـــثون . . .🌐**\n\n%𝟿𝟶 ▬▬▬▬▬▬▬▬▬▭") 
    await asyncio.sleep(1)
    bbbb11 = await bbbb10.edit("JERUSALEM **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت ريبـــثون . . .🌐**\n\n%𝟷𝟶𝟶 ▬▬▬▬▬▬▬▬▬▬💯") 
    sandy = await edit_or_reply(
        bbbb11,
        f"JERUSALEM **إعــادة التشغيــل**\n"
        f"**•─────────────────•**\n\n"
...
async def _(event):
    ...
    o = (await _reputils.runcmd(cmd))[0]
    OUTPUT = f"**⌔∮ [𝗦𝗢𝗨𝗥𝗖𝗘 𝗥𝗘𝗣𝗧𝗛𝗢𝗡](tg://need_update_for_some_feature/) الالاضافات:**\n{o}"
...
async def reppp(event): # Code By T.me/E_7_V
    uname = platform.uname()
    rept = "**- تاريخ تنصيبـك لـ بـوت الـــقدس - 𓆩𝙎𝙊𝙐𝙍𝘾𝞝 JERUSALEM**\n\n"
    if gvarstatus("r_date") is not None: # Code By T.me/E_7_V
