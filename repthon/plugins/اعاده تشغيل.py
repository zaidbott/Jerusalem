...
async def _(event):
    ...
    sandy = await edit_or_reply(
        ...
        f"**⌔∮ يتـم الان اعـادة تشغيـل بـوت ريبـــثون قـد يستغـرق الامـر 1-2 دقيقـه ▬▭ ...**",
    )
    try:
...
async def _(event):
    ...
    await edit_or_reply(event, "**⌔∮جــارِ إيقـاف تشغيـل بـوت ريبـــثون الآن 📟 ... شغِّـلنـي يـدويًـا لاحقًــا**")
